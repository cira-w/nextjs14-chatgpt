...
export const ChatBox = ({ chat, selected }: ChatBoxProps) => {
    ...
    return (
        <div
            key={chat.title}
            className={cn(
                "group relative flex w-full p-2 hover:bg-neutral-900 rounded-md cursor-pointer text-white text-sm",
            ...
            <div className="absolute top-1/2 -translate-y-1/2 right-2 flex z-10">
                {isEditing ? (
                    <button
                        ...
                        className={cn(
                            "bg-gradient-to-r from-transparent from-0% to-neutral-900 to-30% space-x-2 flex pl-3 py-1",
